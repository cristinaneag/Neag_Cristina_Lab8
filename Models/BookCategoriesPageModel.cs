...
namespace Neag_Cristina_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Data.Neag_Cristina_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Neag_Cristina_Lab8Context context, string[] selectedCategories, Book bookToUpdate)
        {
